...
class ConfigInit:
    ...
    def config_init() -> Setting:
        ...
        configfile = os.path.join(Constants.get_value("root_path"), "config", "config.ini")
        ...
        client_id = os.environ.get("CLIENT_ID") if dict_config["USER_SETTING"].get("client_id") == "*******" else \
            dict_config["USER_SETTING"].get("client_id")
        client_secret = os.environ.get("CLIENT_SECRET") if dict_config["USER_SETTING"].get(
            "client_secret") == "*******" else dict_config["USER_SETTING"].get("client_secret")
    ...
    @staticmethod
    def load_token():
        token_path = os.path.join(Constants.get_value("root_path"), "config", "token.json")
